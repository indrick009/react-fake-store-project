    ...
    <div className="max-w-5xl mx-auto px-4 sm:px-6 py-10 pb-20">
      ...
      <div className="flex flex-col md:flex-row gap-12 items-start">
        ...
        <div className="flex-1">
          ...
          <h1 className="font-display text-2xl sm:text-3xl font-bold text-stone-900 leading-tight mb-4">
          ...
          <div className="flex items-center justify-between">
            ...
            <button className="flex items-center gap-2 bg-stone-900 text-white font-body font-medium px-6 py-3 rounded-xl hover:bg-amber-500 transition-colors duration-200 cursor-pointer text-sm">
